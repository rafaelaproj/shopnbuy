// COMPLETE 8: Declare Mock Products
...
void main() {
  // COMPLETE 9: Call Dependency Injector
  setupDependencyAssembler();

  // COMPLETE 10: Inject View Model
  var cartViewModel = dependencyAssembler<CartModel>();

  // COMPLETE 11: Add Mock Products
  ...
  // COMPLETE 12: Write Cart Page Test Cases
  group('Given Cart Page Loads', () {
    ...
    test('Page should consolidate products in cart and show accurate summary data', 
    () {
  ...
  // COMPLETE 13: Write Checkout Test Cases
